 ...
 */
const PAGES = [
  { path: "/zh/studies", title: "AI 评测项目 · telepace" },
  { path: "/zh/studies/new", title: "新建 AI 评测 · telepace" },
  ...
  { path: "/en/studies", title: "Evaluation programs · telepace" },
  { path: "/en/studies/new", title: "New evaluation · telepace" },
