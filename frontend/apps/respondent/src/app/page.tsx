  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-lg text-center">
        <p className="overline mb-4">powered by {siteConfig.brand.name}</p>
        <h1 className="font-display text-5xl mb-6 leading-tight">Nothing to answer here.</h1>
        <p className="text-body text-lg leading-relaxed">
          You've reached the respondent gateway for {siteConfig.brand.name}. Individual interviews live at
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-3">
          ...
          >
            Visit {siteConfig.brand.name}.io
          </Link>
          <Link
        ...
        <p className="text-xs text-muted mt-10">
          ...
          <Link href={`${siteConfig.urls.home}${routes.privacy}`} className="underline text-accent">privacy policy</Link>.
        </p>
      </div>
    </main>
  );
