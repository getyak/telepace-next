      ...
      {(title || language) && (
        <div className="flex items-center justify-between bg-[#1E1E1E] px-4 py-2 border-b border-[#333]">
          ...
          <button
            onClick={handleCopy}
            className={cn(
              "text-xs font-medium px-2 py-1 rounded-btn transition-[color,background-color,transform] duration-150 active:scale-95 transform-gpu motion-reduce:transition-none motion-reduce:active:scale-100",
              copied
      ...
      <div className="relative group">
        {!title && !language && (
          <button
            onClick={handleCopy}
            className={cn(
              "absolute top-3 right-3 text-xs font-medium px-2 py-1 rounded-btn transition-[color,background-color,opacity,transform] duration-150 active:scale-95 transform-gpu motion-reduce:transition-none motion-reduce:active:scale-100",
              copied
