      ...
      <div className="flex items-center gap-1 border-b border-paper/10 px-3 pt-3" role="tablist">
        {TABS.map((key) => (
          <button
            ...
            className={`rounded-t-md px-3.5 py-2 font-mono text-xs transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-paper/60 transform-gpu active:scale-[0.97] active:duration-75 motion-reduce:active:scale-100 ${
              active === key
