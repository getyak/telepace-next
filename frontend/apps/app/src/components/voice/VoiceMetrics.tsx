    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="rounded-card border border-hairline bg-paper-elevated p-5">
          <p className="overline mb-2">Sentiment</p>
          <div className="flex items-center gap-2">
            ...
            >
              {sentimentLabel(metrics.avg_sentiment)}
            </span>
          </div>
        ...
        {/* Pace */}
        <div className="rounded-card border border-hairline bg-paper-elevated p-5">
          <p className="overline mb-2">Speaking pace</p>
          <p
            className={cn(
              "font-display text-2xl",
        ...
        {/* Pauses */}
        <div className="rounded-card border border-hairline bg-paper-elevated p-5">
          <p className="overline mb-2">Pauses</p>
      ...
      <div className="rounded-card border border-hairline bg-paper-elevated p-5">
        <p className="overline mb-4">Emotion distribution</p>
