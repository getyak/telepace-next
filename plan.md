...
- [ ] **T-514 · [验证] Insights 页动作真实生效（Push to Notion / Filter / Dismiss）**
  - 需复测
...
- [ ] **T-524 · [验证] 落地页 scroll-reveal 在无障碍/减少动画/SEO 下的降级**
